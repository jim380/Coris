...
//   votesDataSource = new MatTableDataSource<any>([...this.proposal.currentVotes]);
...
//     this.votesDataSource = new MatTableDataSource<any>([...this.proposal.currentDeposit]);
//     this.votesDataSource.paginator = this.paginators.toArray()[1];
//   }

//   onTabChange(event) {
//     // TODO remove debugging
//     // console.log(event.tab.textLabel);
//     this.initVotesTable(event.tab.textLabel);
//   }
// }
